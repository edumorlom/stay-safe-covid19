        ...
        <TouchableHighlight underlayColor={appStyles.underlayColor}
            ...
            <React.Fragment>
                <View style={{height: '100%', width: '80%'}}>
                    ...
                    <Text style={{color: props.user.sick ? appStyles.redColor : 'green', fontSize: appStyles.regularFontSize}}>{props.user.sick ? props.getLocalizedText("needsHelp") : props.getLocalizedText("volunteer")}</Text>
                    <Text style={{color: appStyles.greyColor, fontSize: appStyles.regularFontSize}}>{props.user.address ? props.user.address.city : ''}</Text>
                    <Text style={{color: appStyles.greyColor, fontSize: appStyles.regularFontSize}}>{props.user.age + " " +  props.getLocalizedText("yearsOld")}</Text>
                </View>
