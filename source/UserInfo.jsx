...
export default function UserInfo(props){
    ...
    return (
        <ScrollView contentContainerStyle={{alignItems: 'center', maxWidth: '100%'}}>
                <UserSelectionButton user={props.user} icon={directionsArrow} onPress={getDirections} getLocalizedText={props.getLocalizedText}/>
            ...
            <View style={{alignItems: 'center', marginTop: '5%', marginBottom: 11}}>
                <Text style={{color: appStyles.redColor, fontWeight: 'bold'}}>{props.getLocalizedText("avoidPhysicalContactDisclaimer")}</Text>
                </View>
        </ScrollView>
    )
}