        ...
        <TouchableHighlight underlayColor={appStyles.underlayColor}
            ...
            <React.Fragment>
                <View>
                    ...
                    <Text style={{color: 'black', fontSize: appStyles.regularFontSize}}>{props.country.TotalConfirmed ? props.getLocalizedText("sick") + props.country.TotalConfirmed : 'Total: 0'}</Text>
